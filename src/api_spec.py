...
from src.schemas.song import *  # Ajout du schéma pour l'API songs
from src.schemas.rating import *  # Ajout du schéma pour l'API ratings
...
# Ajoutez les schémas pour les APIs songs et ratings
